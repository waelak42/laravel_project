        ...
        <div class="col-md-10 mx-auto">
            <div class="card">
                <div class="card-header">
                    <div class="py-3">
                        <a type="button" class="btn btn-info" href="{{ route('city.create') }}" ><i class="fas fa-plus"></i></a>
                    </div>
                </div>
                    ...
                    <table class="table responsive mx-auto">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('city.edit',$city->id) }}" ><i
                                        class="fas fa-edit"></i></a>

                                    <a href="{{ route('city.delete',$city->id) }}" id="delete"><i
